...
and location not in ('England', 'Northern Ireland', 'Scotland', 'Wales')
order by 2,3
...
select continent, location, cast(date as date) as date, new_vaccinations, total_vaccinations, people_vaccinated
